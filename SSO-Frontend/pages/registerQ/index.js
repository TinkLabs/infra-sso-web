        ...
        .then(({data: {data}}) => {
            ...
            .catch(({response: {data: {retCode, retMsg}}}) => {
                if (retCode === '60001') {
                    ...
                    setErrors({form: t(`Password length is at least at 8`)});
                }else {
            ...
            <Container component="form" onSubmit={handleSubmit}>
                ...
                {!submitted && <Content>
                    ...
                    <div className={styles.buttons}>
                        <Button type='button' className={styles.facebook} href={this.props.fbLoginUri}>
                        </Button>
                        <Button type='button'  className={styles.google} href={this.props.googleLoginUri}>
                        </Button>
                    </div>
